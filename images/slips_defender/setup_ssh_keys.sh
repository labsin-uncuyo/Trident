...
SERVER_ROOT_PASSWORD="${SERVER_ROOT_PASSWORD:-admin}"
COMPROMISED_USER="${COMPROMISED_USER:-${SSH_COMPROMISED_USER:-labuser}}"
COMPROMISED_PASSWORD="${COMPROMISED_PASSWORD:-${SSH_COMPROMISED_PASS:-admin}}"
MAX_ATTEMPTS=40
SLEEP_SECONDS=3
